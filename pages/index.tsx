...
const IndexPage = () => (
  <Layout title="Genao Multiservices - Coming Soon">
    <Image
      src="/images/avatar3.png"
      alt="Themeptation "
      width={400}
      height={0}
      className="absolute max-w-[200px] lg:max-w-[400px] h-auto -top-20 md:-right-16 lg:right-5 top-20 animate-blob"
    />
    <Image
      ...
      width={0}
      height={0}
      className="absolute w-full h-screen left-24 bottom-24 animate-blob2"
    />
    <Image
          src="/images/logo.png"
          alt="hero"
          width={300}
          height={0}
          className="absolute max-w-[180px] lg:max-w-[300px] left-24 bottom-24 h-auto animate-blob2"
        />
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        ...
        <h1 className="text-7xl text-4xl lg:text-9xl font-extrabold">En construcción...</h1>
